...
var App = function () {
    ...
    var handleSidebarAndContentHeight = function () {
        ...
        if (body.hasClass("page-footer-fixed") === true && body.hasClass("page-sidebar-fixed") === false) {
            var availabel_height = $(window).height() - $('.footer').height();
            if (content.height() <  availabel_height) {
                content.attr('style', 'min-height:' + availabel_height + 'px !important');
            }
        } else {
    ...
    var handleAccordions = function () {
        ...
        //add scrollabel class name if you need scrollabel panes
        jQuery('body').on('click', '.accordion.scrollabel .accordion-toggle', function () {
            lastClicked = jQuery(this);
        }); //move to faq section

        jQuery('body').on('shown', '.accordion.scrollabel', function () {
