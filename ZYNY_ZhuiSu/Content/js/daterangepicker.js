...
!function ($) {
    ...
    var DateRangePicker = function (element, options, cb) {
        ...
        this.container.find('.calendar').on('click', 'td.availabel', $.proxy(this.clickDate, this));
        this.container.find('.calendar').on('mouseenter', 'td.availabel', $.proxy(this.enterDate, this));
        this.container.find('.calendar').on('mouseleave', 'td.availabel', $.proxy(this.updateView, this));
    ...
    DateRangePicker.prototype = {
        ...
        renderCalendar: function (calendar, selected, minDate, maxDate) {
            ...
            {
                html += '<th class="prev availabel"><i class="icon-angle-left"></i></th>';
            }
            else
            {
                 html += '<th></th>';
            ...
            {
                html += '<th class="next availabel"><i class="icon-angle-right"></i></th>';
            }
            else
            {
                 html += '<th></th>';
