...
(function(mod) {
  ...
  function Display(place, doc) {
    ...
    // scrollabel area is big enough.
    d.heightForcer = elt("div", null, null, "position: absolute; height: " + scrollerCutOff + "px; width: 1px;");
    // Will contain the gutters, if any.
    d.gutters = elt("div", null, "CodeMirror-gutters");
    d.lineGutter = null;
    // Actual scrollabel element.
  ...
  function updateDisplay(cm, viewPort, forced) {
    ...
    for (var first = true;; first = false) {
      ...
      // Clip forced viewport to actual scrollabel area.
  ...
  function registerEventHandlers(cm) {
    ...
    // Sync scrolling between fake scrollbars and real scrollabel
  ...
  // Sync the scrollabel area and scrollbars, ensure the viewport
  ...
  function onScrollWheel(cm, e) {
    ...
    // of the scroll event is removed from the scrollabel element.
  ...
  Doc.prototype = createObj(BranchChunk.prototype, {
    ...
    // are also availabel from CodeMirror (editor) instances.
