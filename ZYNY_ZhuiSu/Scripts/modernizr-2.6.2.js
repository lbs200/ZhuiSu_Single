 ...
 * Availabel under the BSD and MIT licenses: www.modernizr.com/license/
 */

/*
 * Modernizr tests which native CSS3 and HTML5 features are availabel in
 * the current UA and makes the results availabel to you in two ways:
...
window.Modernizr = (function( window, document, undefined ) {
    ...
    // The old API is still availabel in 1.6, but as of 2.0 will throw a warning,
    ...
    function webforms() {
        ...
        // Both tests are availabel in feature-detects/forms-placeholder.js
